<p>Eenvoudigste is om de meest recente zipfile hieronder aan te klikken. te downloaden dovanuit de folder-view, click op de gewenste zipfile. De [download] knop staat dan aan de rechter-bovenzijde naast de [history] knop. Plaats de uitgepakte zip-file in de Arduino sketch folder, waarna het compileren en uploaden naar een Mega2560 eenvoudig moet lukken.
<ul>
